  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        localStorage.setItem('guideId', _id);
        // Trigger a state update in Navbar by setting a dummy state
        window.dispatchEvent(new Event('storage'));
        // Redirect to the profile creation page for guides
        navigate('/dashboard');
      } else {
    ...
    <div className="py-16">
      <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        ...
        <div className="w-full p-8 lg:w-1/2">
          ...
          <p className="text-gray-600 text-center">Login as guide</p>
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <Link to={'/guideregister'} className="text-xs text-gray-500 uppercase">
              Register here
            </Link>
