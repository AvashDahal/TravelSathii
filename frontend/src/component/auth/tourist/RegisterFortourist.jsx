...
const RegisterForguid = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:3000/api/v1/tourist/signup', formData);
      ...
      <div className="py-16">
        <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
          ...
          <div className="w-full p-8 lg:w-1/2">
            ...
            <p className="text-gray-600 text-center">Register as tourist</p>
           ...
           Register
            ...
            <div className="mt-4 flex items-center justify-between">
              ...
              <Link to={'/touristlogin'} className="text-xs text-gray-500 uppercase">
                login here
              </Link>
